...
<div class="container">
    ...
    <div class="product-details">
        <p>A special cake is a uniquely designed dessert crafted for significant occasions or personal milestones.</p>
    ...
    <form action="customform.php" method="POST">
        ...
        <div class="form-group">
            ...
            <select id="toppings" name="toppings" required>
                ...
                <optgroup label="Edible">
                    <option value="Sugar Flowers">Sugar Flowers</option>
                    <option value="Sprinkles">Sprinkles</option>
                    <option value="Dragees">Dragees</option>
                </optgroup>
                <optgroup label="Non-Edible">
                    <option value="Real Flowers">Real Flowers</option>
        ...
        <div class="form-group">
            ...
            <input type="date" name="date_to_delivered" id="date_to_delivered" required>
        </div>
    ...
    <a href="product.php"><button type="submit" id="cancel">Cancel</button></a>
