...
<head>
    ...
    <link rel="stylesheet" href="CSS\orderformstylea.css">
</head>
<style>
    body{
...
<div class="product-container">
        ...
        <div class="product-details">
            ...
            <p style="text-align: left;"><?php echo $sizenflavor; ?></p>
    ...
    <div class="container">
        ...
        <a href="product.php" style="text-decoration: none;"><button type="submit">Cancel</button></a>
